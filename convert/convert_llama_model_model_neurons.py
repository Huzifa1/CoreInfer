...
class CustomMLPLayer(nn.Module):
    def __init__(self, model_neurons, weight, num, sparsity, start_num, token_sparsity, memory_limit, cpu_only, name):
    ...
    for name, module in tqdm(model.named_modules(), desc="Convert Llama Models"):
        ...
        if "down" in name or "up" in name or "gate" in name:
            ...
            if num>start_num and num<end_num:
                ...
                NewLayer = CustomMLPLayer(model_neurons, module.weight, num, sparsity, start_num, token_sparsity, memory_limit, cpu_only, name)
